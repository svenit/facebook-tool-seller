<?php
    session_start();
    $_SESSION['js'] = 'livestream/share.js';
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30">Giúp bạn chia sẻ video live stream lên các nhóm bạn tham gia bằng cookie</p>
                                ...
                                <div class="form-group">
                                    <label>ID Video Live Stream</label>
