                    ...
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30">Giúp bạn chia sẻ live stream đến tất cả các nhóm bạn đang tham gia</p>
                                <div class="" action="#" novalidate="">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <button type="submit" v-if="options.getGroupId == 'custome' && listGroupId.length > 0 || copyListGroupId.length > 0" @click="isStop = !isStop,share(null,null,null,'share-live-stream')" class="btn btn-primary waves-effect waves-light submit">{{ isStop ? `Bắt Đầu ( ${customeListGroupId.length} )` : 'Dừng Lại' }}</button> 
                                            <button type="submit" v-else-if="options.getGroupId != 'custome'" @click="isStop = !isStop,request('share-live-stream')" class="btn btn-primary waves-effect waves-light submit">{{ isStop ? 'Bắt Đầu' : 'Dừng Lại' }}</button> 
                                            <button :disabled="loading" type="submit" v-if="options.getGroupId == 'custome' && listGroupId.length == 0 && copyListGroupId.length == 0" @click="request('share-live-stream')" class="btn btn-primary waves-effect waves-light submit">Lấy Danh Sách ID</button> 
                                        </div>
                                    </div>
                                </div>
                            </div>
