...
class ExecuteController extends BaseController
{
    ...
    public function getGroupId($request)
    {
        ...
        $logs = @file_get_contents(__DIR__.'../../../logs/'.$request['path'].'-'.date('d-m-Y').'.txt');
    ...
    public function shareLiveStream($request)
    {
        if(isset($request))
        {
            ...
            {
                $time = date('d-m-Y');
                $file = fopen(__DIR__.'../../../logs/'.'share-live-stream-'.$time.'.txt','a+');
    ...
    {
        $time = date('d-m-Y');
        $file = fopen(__DIR__.'../../../logs/'.'share-post-'.$time.'.txt','a+');
        if(isset($request))
        {
    ...
    public function postToGroup($request)
    {
        ...
        else
        {
            ...
            {
                $time = date('d-m-Y');
                $file = fopen(__DIR__.'../../../logs/'.'post-group-'.$time.'.txt','a+');
                fwrite($file,$request['idGroup']."\n");
